"""Simple test suite for frontrun strategy execution"""
import pytest
...
@pytest.mark.asyncio
async def test_execute_frontrun_attack(mock_strategy):
    """Test execution of frontrun attack"""
    # Create a frontrun opportunity
    opportunity = {
        'type': 'frontrun',
        'dex': 'uniswap',
        'token_in': WETH,

"""Simple tests for arbitrage strategy"""
import unittest
...
class TestArbSimple(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_execute_arbitrage_success(self, mock_execute_flash_loan, mock_encode_callback):
    ...
    @patch('src.base_strategy.MEVStrategy._encode_strategy_callback')
    @patch('src.base_strategy.MEVStrategy._execute_with_flash_loan')
    async def test_execute_arbitrage_failure(self, mock_execute_flash_loan, mock_encode_callback):
        ...
        # Mock strategy callbacks to simulate failure
        mock_encode_callback.return_value = b'0x123456'

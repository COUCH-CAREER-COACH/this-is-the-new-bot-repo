"""Core tests for arbitrage strategy"""
import unittest
...
class TestArbCore(unittest.IsolatedAsyncioTestCase):
    ...
    @patch('src.arbitrage_strategy._calculate_optimal_arbitrage')
    @patch('src.utils.dex_utils.DEXHandler.decode_swap_data')
    @patch('src.utils.dex_utils.DEXHandler.get_pool_info')
    async def test_analyze_profitable_tx(self, mock_get_pool_info, mock_decode_swap, mock_calc_arb):
        ...
        mock_calc_arb.return_value = (1000000000000000000, 100000000000000000)  # 1 ETH, 0.1 ETH profit
    ...
    @patch('src.utils.dex_utils.DEXHandler.decode_swap_data')
    @patch('src.utils.dex_utils.DEXHandler.get_pool_info')
    async def test_analyze_unprofitable_tx(self, mock_get_pool_info, mock_decode_swap, mock_calc_arb):
        ...
        mock_calc_arb.return_value = (0, 0)

...
def create_mock_contract(address: str):
    """Create a mock contract with proper address"""
    mock_contract = Mock()
...
async def strategies():
    ...
    # Create mock contract with proper address
    mock_contract = create_mock_contract(ROUTER)

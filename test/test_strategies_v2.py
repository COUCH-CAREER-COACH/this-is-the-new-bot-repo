...
from test.mock_flash_loan_v2 import MockFlashLoan
...
async def sandwich_strategy():
    ...
    with patch('src.base_strategy.FlashLoan', MockFlashLoan), \
        ...
        strategy.flash_loan = MockFlashLoan(web3, config)
        return strategy
...
async def test_sandwich_attack(sandwich_strategy):
    ...
    assert sandwich_strategy.flash_loan.execute.called, "Flash loan should be executed"
...
async def test_frontrun_attack(frontrun_strategy):
    ...
    assert frontrun_strategy.flash_loan.execute.called, "Flash loan should be executed"
...
async def test_jit_strategy(jit_strategy):
    ...
    assert jit_strategy.flash_loan.execute.called, "Flash loan should be executed"

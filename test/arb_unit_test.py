...
class TestArbitrageUnit(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_analyze_profitable_tx(self, mock_to_wei):
        ...
        strategy.dex_handler.get_pool_info = AsyncMock(side_effect=[
            {  # Uniswap pool
        ...
        strategy._calculate_optimal_arbitrage = AsyncMock(return_value=(1000000000000000000, 100000000000000000))
    ...
    async def test_analyze_unprofitable_tx(self, mock_to_wei):
        ...
        strategy._calculate_optimal_arbitrage = AsyncMock(return_value=(0, 0))
